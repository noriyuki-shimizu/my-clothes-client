<template>
    <div id="privacy_policy_back_ground">
        <div id="privacy_policy_block">
            <h1>Privacy Policy</h1>
            <a-divider />
            <p>
                Noriyuki Shimizu built the MyClothes app as a Free app. This
                SERVICE is provided by Noriyuki Shimizu at no cost and is
            ...
            <p>
                ...
                in our Terms and Conditions, which is accessible at MyClothes
